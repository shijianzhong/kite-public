...
{#if localShowTooltip && referenceElement && browser}
	<Portal>
		<div 
			...
			class="absolute top-0 left-0 z-[70] pointer-events-none {floating.isPositioned ? 'opacity-100' : 'opacity-0 invisible'}"
		...
		>
			...
			<!-- Tooltip content -->
			<div class="bg-gray-800 dark:bg-gray-700 text-white text-xs px-3 py-2 rounded-md shadow-lg max-w-xs">
