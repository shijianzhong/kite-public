...
<div class="space-y-4">
	...
	<div class="flex items-center justify-between">
		<label for="preloading-enabled" class="text-sm text-gray-700 dark:text-gray-300">
	...
	<!-- Enable on Mobile -->
	<div class="flex items-center justify-between">
		<label for="preloading-mobile" class="text-sm text-gray-700 dark:text-gray-300">
	...
	<div class="space-y-2">
		<label for="category-delay" class="text-sm text-gray-700 dark:text-gray-300">
	...
	<div class="space-y-2">
		<label for="preload-timeout" class="text-sm text-gray-700 dark:text-gray-300">
