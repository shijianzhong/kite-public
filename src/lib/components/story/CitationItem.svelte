...
const containerClasses = $derived(
	isHighlighted
		? 'bg-yellow-50 dark:bg-yellow-900 rounded p-1'
		: ''
);
...
{#if item.isCommon}
	...
	<div class="flex items-start {spacingClasses} {textSizeClasses} {containerClasses}" 
...
{:else if item.article}
	...
	<div class="flex items-center {spacingClasses} {textSizeClasses} {containerClasses}" 
