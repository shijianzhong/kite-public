 ...
 */
export function formatTimeAgo(timestamp: number, s: (key: string, params?: Record<string, string>) => string | undefined): string {
  ...
  if (diff < 3600) {
    ...
    return s('time.updated.minutes', { count: minutes.toString() }) || `Updated ${minutes} minutes ago`;
  }
