...
vi.mock('$lib/utils/imagePreloader', () => ({
  ...
  extractStoryImages: vi.fn((story: any) => story.articles?.map((a: any) => a.image).filter(Boolean) || []),
  isImageCached: vi.fn(() => false),
  clearImageCache: vi.fn(),
  getImageCacheStats: vi.fn(() => ({ cachedCount: 0, downloadingCount: 0, cachedImages: [] })),
...
describe('ImagePreloadingService', () => {
  beforeEach(() => {
    ...
    vi.mocked(imagePreloader.extractStoryImages).mockImplementation((story: any) => 
  ...
  describe('preloadCategory', () => {
    it('should preload images for a category', async () => {
      const stories = [
        { 
          ...
          articles: [{ title: 'Article 1', link: 'link1', domain: 'domain1', date: '2024-01-01', image: 'image1.jpg' }, { title: 'Article 2', link: 'link2', domain: 'domain2', date: '2024-01-01', image: 'image2.jpg' }] 
        },
        { 
          cluster_number: 2,
          category: 'test',
          ...
          articles: [{ title: 'Article 3', link: 'link3', domain: 'domain3', date: '2024-01-01', image: 'image3.jpg' }] 
        }
      ];

      await imagePreloadingService.preloadCategory(stories);

      expect(imagePreloader.preloadImages).toHaveBeenCalledWith(['image1.jpg', 'image2.jpg', 'image3.jpg'], false);
    });
    ...
    it('should skip preloading in time travel mode when configured', async () => {
      ...
      const stories = [{ 
        ...
        articles: [{ title: 'Article', link: 'link', domain: 'domain', date: '2024-01-01', image: 'image1.jpg' }] 
      }];
      await imagePreloadingService.preloadCategory(stories);
    ...
    it('should handle already cached images', async () => {
      ...
      const stories = [{ 
        ...
        title: 'Test Story',
        short_summary: 'Summary',
        articles: [{ title: 'Article', link: 'link', domain: 'domain', date: '2024-01-01', image: 'cached.jpg' }] 
      }];
      await imagePreloadingService.preloadCategory(stories);
  ...
  describe('preloadStory', () => {
    it('should call preloadImages for story with images', async () => {
      ...
      const story = { 
        ...
        short_summary: 'Summary',
        articles: [
          { title: 'Article 1', link: 'link1', domain: 'domain1', date: '2024-01-01', image: 'unique1.jpg' }, 
          { title: 'Article 2', link: 'link2', domain: 'domain2', date: '2024-01-01', image: 'unique2.jpg' }
        ] 
      };
      ...
      expect(imagePreloader.preloadImages).toHaveBeenCalledWith(['unique1.jpg', 'unique2.jpg'], true);
    });
  });
  ...
  describe('real behavior tests', () => {
    it('should handle concurrent preloads correctly', async () => {
      ...
      const category1 = [{ 
        ...
        title: 'Story 1',
        short_summary: 'Summary',
        articles: [{ title: 'A', link: 'l', domain: 'd', date: '2024-01-01', image: 'cat1.jpg' }] 
      }];
      ...
      const category2 = [{ 
        ...
        title: 'Story 2',
        short_summary: 'Summary',
        articles: [{ title: 'B', link: 'l', domain: 'd', date: '2024-01-01', image: 'cat2.jpg' }] 
      }];
    ...
    it('should handle errors without throwing', async () => {
      ...
      const stories = [{ 
        ...
        title: 'Test Story',
        short_summary: 'Summary',
        articles: [{ title: 'Article', link: 'link', domain: 'domain', date: '2024-01-01', image: 'error.jpg' }] 
      }];
